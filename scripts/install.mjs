...
say('');
say('Next:');
say('  node scripts/repos.mjs scan <dir>     find your repositories and propose a check for each');
say('  node scripts/repos.mjs list           see what is registered and how work is delivered');
say('');
